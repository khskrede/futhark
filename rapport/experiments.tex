...
\begin{figure}[ht!]
\subfloat[Thick
bacon]{\label{fig:thick_bacon}\includegraphics[width=0.5\textwidth]{thick_bacon}}
\subfloat[Regular
bacon]{\label{fig:regular_bacon}\includegraphics[width=0.5\textwidth]{regular_bacon}}
